...
# this was taken from: https://sourceforge.net/p/reduce-algebra/code/HEAD/tree/trunk/scripts/gccdefs.sh
# more info in https://sourceforge.net/p/reduce-algebra/code/HEAD/tree/trunk/README
