...
#line 131 "tokenize.nw"
#line 347 "tokenize.nw"
    prog_name = argv[0];
#line 132 "tokenize.nw"
#line 328 "tokenize.nw"
    file_count = argc - 1;
#line 133 "tokenize.nw"
#line 317 "tokenize.nw"
    argc--;
    do {
#line 298 "tokenize.nw"
        if (file_count > 0) {
            file_name = *(++argv);
...
#line 255 "tokenize.nw"
                ...
                if (c == '\n') {
                    ...
                    *(ptr - 1) = '\n';
                    ...
                    line_count++;
                    {
#line 112 "tokenize.nw"
#line 33 "tokenize.nw"
                        char *b, *e;
#line 103 "tokenize.nw"
                        size_t line_length = ptr - line_start;
...
#line 25 "tokenize.nw"
            printf("2 \n");
#line 289 "tokenize.nw"
        }
#line 322 "tokenize.nw"
#line 206 "tokenize.nw"
        close(fd);
#line 323 "tokenize.nw"
#line 202 "tokenize.nw"
