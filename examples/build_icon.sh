...
git_repos=${thisdir}/ctarbide_icon.git
branch=prefix-lib-icon
version=${branch}
...
do_custom(){
    ...
    ${MAKE}
    (umask 002; ${MAKE} Install dest=icon-package)

    sharedir=icon

    mkdir -p ${prefix}/bin
    mv -f icon-package/bin/* ${prefix}/bin

    mkdir -p ${prefix}/share/man/man1
    mv -f icon-package/man/man1/* ${prefix}/share/man/man1/

    mkdir -p ${prefix}/share/${sharedir}/doc
    mv -f icon-package/README ${prefix}/share/${sharedir}/
    mv -f icon-package/doc/* ${prefix}/share/${sharedir}/doc/

    mkdir -p ${prefix}/lib/icon
    mv -f icon-package/lib/icon/* ${prefix}/lib/icon/
}
